    ...
    <div className="relative inline-block text-left">
      <div style={{ position: 'relative' }}>
        ...
        >
          ...
          <IoMdArrowDropdownCircle className="ml-1 w-4 h-6" />
        </button>
        {isOpen && (
          <div className="absolute top-full right-0 mt-1 w-32 h-36 overflow-y-auto rounded-md shadow-lg bg-gray-800 ring-1 ring-black ring-opacity-5">
